...
/***/ function(module, exports, __webpack_require__) {
	...
	function getJSON(uri) {
	    return fetch((0, _api.formatUri)(uri), {
	        method: 'get',
	...
	function putJSON(uri, data) {
	    return fetch((0, _api.formatUri)(uri), buildRequest('put', data)).then(_validateResponse2.default).then(_parseJson2.default);
	}

	function postJSON(uri, data) {
	    return fetch((0, _api.formatUri)(uri), buildRequest('post', data)).then(_validateResponse2.default).then(_parseJson2.default);
	};

	function deleteJSON(uri) {
	    return fetch((0, _api.formatUri)(uri), {
	        method: 'delete',
	        headers: (0, _api.withAuthorization)({})
	    }).then(_validateResponse2.default).then(_parseJson2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var URI = process.env.API_ENDPOINT;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EntitySchema = __webpack_require__(10);

	var _EntitySchema2 = _interopRequireDefault(_EntitySchema);

	var _IterableSchema = __webpack_require__(11);

	var _IterableSchema2 = _interopRequireDefault(_IterableSchema);

	var _UnionSchema = __webpack_require__(13);
